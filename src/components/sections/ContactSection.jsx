...
const ContactSection = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xsl">
        <div className="grid gap-12 md:grid-cols-[0.8fr_1fr] md:items-start">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm font-inter leading-relaxed text-slate-700 tablet:text-base">
              Every system starts with a discovery query. Get in touch to
              outline your workflow inefficiencies and map out a prototype.
            </p>
          ...
          <div className="rounded border border-neutral-300 bg-neutral-50 p-6 tablet:p-8">
            {status === "success" ? (
              <div className="space-y-4 text-center py-8">
                <h3 className="font-mono text-lg font-semibold text-green-700">
                  Query Logged
                </h3>
                <p className="text-sm font-inter text-slate-700">
                  Our system has recorded your coordinates. An engineer will
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1">
                  ...
                  >
                    ...
                    <option value="tools">
                      AI Internal Dashboard / Admin Panel
                    </option>
