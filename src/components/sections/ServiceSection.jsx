...
const services = [
  {
    ...
    description:
      "Modern websites engineered as business systems rather than static pages. Features integrated lead capture, CRM synchronization, automated scheduling, and built-in SEO pipelines.",
    link: "/service#websites",
  },
  {
    title: "AI Internal Tools for SMBs",
    description:
      "Tailored operational software designed to automate manual labor. Includes admin panels, inventory trackers, secure customer portals, and real-time activity dashboards.",
    link: "/service#tools",
  },
  {
    title: "Creator Infrastructure",
    description:
      "Dedicated digital architecture for personal brands and digital creators. Features subscription portals, digital product delivery engines, and automated content publishing loops.",
    link: "/service#creator",
  },
  {
    title: "AI Workflow Automation",
    description:
      "Operational efficiency engines linking messaging platforms to internal databases. Features automated WhatsApp notifications, customer support agents, and lead triage pipelines.",
...
const ServiceSection = () => {
  return (
    ...
    >
      <div className="mx-auto max-w-5xll">
        <div className="space-y-4">
          ...
          <p className="text-sm max-w-3xl font-inter leading-relaxed text-slate-700 tablet:text-base">
            We build modular, repeatable infrastructure for small businesses,
            clinics, creators, and startups.
          </p>
        </div>
